...
function useHookstate(source) {
  var parentMethods =
    typeof source === "object" && source !== null ? source[self] : undefined;
  if (parentMethods) {
    if (parentMethods.isMounted) {
      ...
      // eslint-disable-next-line react-hooks/rules-of-hooks
      var _b = React.useState({ state: parentMethods.state }),
        value_1 = _b[0],
        setValue_2 = _b[1];
      return useSubscribedStateMethods(
        value_1.state,
    ...
    var _c = React.useState(function () {
      ...
      value_2 = _c[0],
      setValue_3 = _c[1];
    var result = useSubscribedStateMethods(
      value_2.state,
      RootPath,
      function () {
...
var ErrorId;
(function (ErrorId) {
  ErrorId[(ErrorId["InitStateToValueFromState"] = 101)] =
    "InitStateToValueFromState";
  ErrorId[(ErrorId["SetStateToValueFromState"] = 102)] =
    "SetStateToValueFromState";
  ...
  ErrorId[(ErrorId["SetStateNestedToPromised"] = 105)] =
    "SetStateNestedToPromised";
  ...
  ErrorId[(ErrorId["PreventExtensions_State"] = 205)] =
    "PreventExtensions_State";
  ErrorId[(ErrorId["PreventExtensions_Value"] = 206)] =
    "PreventExtensions_Value";
  ...
  Store.prototype.set = function (path, value, mergeValue) {
    ...
    if (path.length === 0) {
      ...
      if (value === none) {
        ...
        this._promised &&
        !this._promised.resolver &&
        !this._promised.fullfilled
      ) {
...
var StateMethodsImpl = /** @class */ (function () {
  ...
  StateMethodsImpl.prototype.setUntracked = function (newValue, mergeValue) {
    ...
    if (
      ...
      newValue !== null &&
      newValue[SelfMethodsID]
    ) {
      throw new StateInvalidUsageError(
        this.path,
        ErrorId.SetStateToValueFromState
      );
    }
    ...
    if (Array.isArray(currentValue)) {
        ...
        Object.keys(sourceValue)
          ...
          .forEach(function (i) {
            ...
            if (newPropValue === none) {
              ...
              deletedOrInsertedProps =
                deletedOrInsertedProps || !(index in currentValue);
      ...
      Object.keys(sourceValue).forEach(function (key) {
        ...
        if (newPropValue === none) {
          ...
          deletedOrInsertedProps =
            deletedOrInsertedProps || !(key in currentValue);
    ...
    var update = function () {
      ...
      for (var _i = 0, paths_1 = paths; _i < paths_1.length; _i++) {
        ...
        if (firstChildKey === undefined) {
          ...
          var firstChildValue =
            _this.childrenCache && _this.childrenCache[firstChildKey];
  ...
  Object.defineProperty(StateMethodsImpl.prototype, "promised", {
    get: function () {
      ...
      if (
        currentValue === none &&
        this.state.promised &&
        !this.state.promised.fullfilled
      ) {
        return true;
      }
      return false;
    ...
    if (typeof p === "function") {
      ...
      return [
        this.state.getPlugin(p) ||
          new StateInvalidUsageError(
            this.path,
            ErrorId.GetUnknownPlugin,
            p.toString()
          ),
        this
      ];
...
function proxyWrap(
  ...
  return new Proxy(targetBootstrap, {
    ...
    apply: function (target, thisArg, argArray) {
      return onInvalidUsage(
        isValueProxy ? ErrorId.Apply_State : ErrorId.Apply_Value
      );
    },
    construct: function (target, argArray, newTarget) {
      return onInvalidUsage(
        isValueProxy ? ErrorId.Construct_State : ErrorId.Construct_Value
      );
    }
  });
}
function createStore(initial) {
  ...
  if (
    ...
    initialValue !== null &&
    initialValue[SelfMethodsID]
  ) {
    throw new StateInvalidUsageError(
      RootPath,
      ErrorId.InitStateToValueFromState
    );
  }
  return new Store(initialValue);
}
function useSubscribedStateMethods(state, path, update, subscribeTarget) {
  var link = new StateMethodsImpl(
    state,
    path,
    state.get(path),
    state.edition,
